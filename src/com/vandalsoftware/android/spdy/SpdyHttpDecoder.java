...
import static com.vandalsoftware.android.spdy.SpdyCodecUtil.isServerId;
...
public class SpdyHttpDecoder extends OneToOneDecoder {
    ...
    private static HttpRequest createHttpRequest(int spdyVersion, SpdyHeaderBlock requestFrame)
        ...
        HttpRequest httpRequest = new BasicHttpRequest(method.getName(), url,
                new ProtocolVersion(httpVersion.getProtocolName(), httpVersion.getMajorVersion(),
        ...
        httpRequest.removeHeaders(HttpHeaders.Names.TRANSFER_ENCODING);
    ...
    private static HttpResponse createHttpResponse(int spdyVersion, SpdyHeaderBlock responseFrame)
        ...
        ProtocolVersion v = new ProtocolVersion(version.getProtocolName(),
                version.getMajorVersion(), version.getMinorVersion());

        HttpResponse httpResponse = new BasicHttpResponse(v, status.getCode(),
        ...
        // Transfer-Encoding header is not valid
        httpResponse.removeHeaders(HttpHeaders.Names.TRANSFER_ENCODING);
        httpResponse.removeHeaders(HttpHeaders.Names.TRAILER);
